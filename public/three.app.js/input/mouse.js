class Mouse {
	...
	static onmove( event ) {
		...
		// // ctrl + LMB
		// if( Keyboard.ctrl[0] == true && this.buttons[ event.button ] == 1 ) {
			
		// 	//let obj = ;
		// 	//log( obj );
		// 	if( App.picker.obj != undefined ) {
		// 		App.world.scene.add( sphere( 0.01, App.picker.obj.point, V0, mat() ));
		// 	}

		// 	// // ctrl + X - create map
		// 	// if ( Keyboard.ctrl[0] == true && Keyboard.keys[88][0] == true )
		// 	// 	if( App.picker.pick.object.cinc != undefined ) {
		// 	// 		//log( App.picker.pick.object.cinc.data.material.map.image );
		// 	// 		log( App.picker.pick.object.cinc.mesh.name );
		// 	// 		App.picker.pick.object.cinc.make_uv_map();
		// 	// 	}
		// }
	}
	...
	static onclick( event ) {
		...
		//if( App.pick != undefined ) log( App.pick.face.a + ' ' + App.pick.face.b + ' ' + App.pick.face.c );

		// if( App.picker.pick != undefined ) {
		// 	let obj = App.picker.pick;
		// 	log( obj );
		// 	App.world.scene.add( sphere( 0.01, obj.point, V0, mat() ));

		// 	// ctrl + X - create map
		// 	if ( Keyboard.ctrl[0] == true && App.keyboard.keys[88][0] == true )
		// 		if( App.picker.pick.object.cinc != undefined ) {
		// 			//log( App.picker.pick.object.cinc.data.material.map.image );
		// 			log( App.picker.pick.object.cinc.mesh.name );
		// 			App.picker.pick.object.cinc.make_uv_map();
